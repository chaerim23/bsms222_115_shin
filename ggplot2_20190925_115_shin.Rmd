...
murders %>% ggplot()
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-2-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-3-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-4-1.png)
...
p + geom_point(aes(population/10^6, total), size = 3) +
  geom_text(aes(population/10^6, total, label = abb))
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-5-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-6-1.png)
This is preferred as it makes it easier to read the text. In Section [8.11](https://rafalab.github.io/dsbook/ggplot2.html#add-on-packages) we learn a better way of assuring we can see the points and the labels.
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-7-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-8-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-9-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-10-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-11-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-12-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-example-13-1.png)
...
murders %>% ggplot(aes(population/10^6, total, label = abb)) +   
  ...
  theme_economist()
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/final-ggplot-example-1.png)
...
qplot(x, y)
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/qplot-example-0-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/unnamed-chunk-352-1.png)
