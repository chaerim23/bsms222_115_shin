---
title: "Chapter 9 Visualizing data distributions"
...
Rather than using data, the normal distribution is defined with a mathematical formula. For any interval $(a,b)$, the proportion of values in that interval can be computed using this formula:$$Pr(a<x<b)=\int_a^b \frac{1}{\sqrt{2\pi}s} e^{-\frac{1}{2}\left( \frac{x-m}{s} \right)^2}dx$$
...
2. Define a vector of quantiles $q_1,…,q_m$ for your data for the proportions $p_1,…,p_m$. We refer to these as the *sample quantiles*.
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/qqplot-original-1.png)
...
```{r}
male_percentile <- heights$height[heights$sex=="Male"] %>%
  quantile(probs=seq(0.1, 0.9, 0.2))
male_percentile
female_percentile <- heights$height[heights$sex=="Female"] %>%
  quantile(probs=seq(0.1, 0.9, 0.2))
female_percentile
```
...
```{r}
a <- mean(x > 79 & x <= 81)
b <- pnorm(81, mean, sd) - pnorm(79, mean, sd)
a/b
```
answer : 1.61
...
In Chapter [8](https://rafalab.github.io/dsbook/ggplot2.html#ggplot2), we introduced the **ggplot2** package for data visualization. Here we demonstrate how to generate plots related to distributions, specifically the plots shown earlier in this chapter.
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/barplot-geom-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/unnamed-chunk-382-1.png)
...
heights %>% 
  ...
  ggtitle("Histogram")
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/height-histogram-geom-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-density-1.png)
...
heights %>% filter(sex=="Male") %>%
  ...
  geom_qq()
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-qq-1.png)
...
heights %>% filter(sex=="Male") %>%
  ...
  geom_abline()
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot-qq-dparams-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/ggplot2-image-new-colors-1.png)
...
qplot(x)
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/qplot-example-1-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/qplot-example-2-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/qplot-example-3-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/qplot-example-4-1.png)
We can also use the `geom` argument to generate a density plot instead of a histogram:
```{r}
qplot(x, geom = "density")
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/qplot-example-5-1.png)
...
```
[](https://rafalab.github.io/dsbook/book_files/figure-html/qplot-example-6-1.png)
